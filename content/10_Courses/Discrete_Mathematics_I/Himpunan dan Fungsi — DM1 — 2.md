...
Mengapa $2^n$? Karena untuk setiap elemen, kamu punya 2 pilihan: memasukkannya ke dalam subhimpunan, atau tidak. Dengan $n$ elemen, ada $2 \times 2 \times \cdots \times 2 = 2^n$ kombinasi pilihan (Product Rule dari [[Logika dan Pencacahan — DM1 — 1#6.2 The Product Rule (Aturan Perkalian)|pencacahan]]).
...
Diagram Venn sangat berguna untuk memvisualisasikan dan memverifikasi hubungan antara himpunan, terutama ketika melibatkan inklusi-eksklusi ([[Logika dan Pencacahan — DM1 — 1#6.1 The Sum Rule (Aturan Penjumlahan)|Sum Rule]] dan konsepnya akan diperluas di minggu ke-14).
...
Perhatikan: $|A \times B| = |A| \cdot |B|$ — ini adalah Product Rule dari [[Logika dan Pencacahan — DM1 — 1#6.2 The Product Rule (Aturan Perkalian)|pencacahan]]!
